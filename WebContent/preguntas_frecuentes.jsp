    ...
    <div class="main_bg"><!-- start main -->    
        <div class="container">        
        	<div class="col-md-10 text-justify centrar margentb2">                
				...
				<p>Hay dos opciones para registrase en Vayamos Juntos: la primera es utilizando el formulario de registración y crear una cuenta. La segunda opción es utilizar tu cuenta de Facebook.</p>
				
				<h4>3.- Quién puede registrarse?</h4>
				<p>Cualquier persona mayor de 18 años.</p>
				
				<h4>4.- Cómo publico un viaje?</h4>
				<p>A través de 3 sencillos pasos, en donde definís a donde y cuando viajás. Podés publicar un viaje haciendo click <a href="http://vayamosjuntos.com.ar/publishRide.do">aquí</a>.</p>
				
				<h4>5.- Cómo encuentro con quien compartir un viaje?</h4>
				<p>A través del buscador, en donde definís a donde y cuando viajás. El sistema te mostrará una lista de posibles viajes a compartir. Podés comenzar a buscar ahora haciendo click <a href="http://vayamosjuntos.com.ar/search.do">aquí</a>.</p>
				...
				<p>No, aunque el espíritu de compartir un viaje es compartir los gastos. Vayamos Juntos permite que los usuarios acuerden libremente un monto entre ellos. El monto de la colaboración con los gastos lo fija el conductor cuando publica el viaje. Si sos pasajero, podés definir con que monto estarías dispuesto a colaborar al momento de realizar el viaje.</p>
