			...
			<div class="col-md-12">
				...
				<s:form cssClass="form-signin" role="form" theme="simple" action="registrarEvento">
					<div class="form-group">
						<label for="exampleInputEmail1"><s:text name="evento.fecha" /></label>
					...
					<div class="form-group">
						<label for="nombre"><s:text name="evento.nombre" /></label>
					...
					<div class="form-group">
						<label for="exampleInputEmail1"><s:text name="evento.ubicacion" /></label>
